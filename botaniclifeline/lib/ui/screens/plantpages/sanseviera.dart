...
class SansevieraPage extends StatefulWidget {
  const SansevieraPage({Key? key}) : super(key: key);

  @override
  _SansevieraPageState createState() => _SansevieraPageState();
}

class _SansevieraPageState extends State<SansevieraPage> {
  bool r1 = false;
  bool r2 = false;
