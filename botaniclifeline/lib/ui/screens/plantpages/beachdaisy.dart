...
class BeachDaisyPage extends StatefulWidget {
  const BeachDaisyPage({Key? key}) : super(key: key);

  @override
  _BeachDaisyPageState createState() => _BeachDaisyPageState();
}

class _BeachDaisyPageState extends State<BeachDaisyPage> {
  bool r1 = false;
  bool r2 = false;
  String dropdownValue = 'Vegetative';
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: CircleAvatar(
                    radius: 60,
                    backgroundImage: ExactAssetImage('assets/images/plant-three.png'),
              ...
              Padding(
                ...
                child: CheckboxListTile(
                  ...
                  subtitle: const Text('1st of July'),
                  secondary: const Icon(Icons.create_rounded),
                  value: r2,
                  onChanged: (bool? value) {
                    setState(() {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Between 15°C and 24°C & normal room humidity',
                        ),
                        leading: Icon(
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Prefers 6-8 hours of direct sunlight',
                        ),
                        leading: Icon(
                          Icons.wb_sunny,
                          size: 30,
