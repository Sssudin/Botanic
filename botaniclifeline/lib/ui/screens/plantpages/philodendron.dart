...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: PhilodendronPage(),
    );
  }
}

class PhilodendronPage extends StatefulWidget {
  const PhilodendronPage({Key? key}) : super(key: key);

  @override
  _PhilodendronPageState createState() => _PhilodendronPageState();
}

class _PhilodendronPageState extends State<PhilodendronPage> {
  bool r1 = false;
  bool r2 = false;
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: CircleAvatar(
                    radius: 60,
                    backgroundImage: const ExactAssetImage('assets/images/plant-two.png'),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Between 18°C and 29°C & moderate to high humidity',
                        ),
                        leading: Icon(
