...
class MeadowSagePage extends StatefulWidget {
  const MeadowSagePage({Key? key}) : super(key: key);

  @override
  _MeadowSagePageState createState() => _MeadowSagePageState();
}

class _MeadowSagePageState extends State<MeadowSagePage> {
  bool r1 = false;
  bool r2 = false;
  String dropdownValue = 'Flowering';
            ...
            children: [
              Padding(
                ...
                child: Container(
                  ...
                  child: CircleAvatar(
                    radius: 60,
                    backgroundImage: const ExactAssetImage('assets/images/plant-five.png'),
              ...
              Padding(
                padding: const EdgeInsets.all(3.0),
                child: CheckboxListTile(
                  title: const Text('Trim leaves'),
                  subtitle: const Text('1st of December'),
                  secondary: const Icon(Icons.create_rounded),
                  value: r2,
                  onChanged: (bool? value) {
                    setState(() {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          'Between 18°C and 27°C & normal room humidity',
                        ),
                        leading: Icon(
