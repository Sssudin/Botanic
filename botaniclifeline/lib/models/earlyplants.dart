class EarlyPlant {
  ...
  //List of Plants data
  static List<EarlyPlant> earlyplantList = [
    EarlyPlant(
        plantId: 0,
        price: 22,
        category: 'Indoor',
  ...
  static List<EarlyPlant> getFavoritedPlants(){
    List<EarlyPlant> _travelList = EarlyPlant.earlyplantList;
    return _travelList.where((element) => element.isFavorated == true).toList();
  }

  //Get the cart items
  static List<EarlyPlant> addedToCartPlants(){
    List<EarlyPlant> _selectedPlants = EarlyPlant.earlyplantList;
